...
G = 0.3
SPEEDFLY = -4
BIRDIMG = pygame.image.load('/Users/user/handstracking-master/img/bird1.png')
...
DISTANCE = 250
COLUMNSPEED = 1
COLUMNIMG = pygame.image.load('/Users/user/handstracking-master/img/column.png')

BACKGROUND = pygame.image.load('/Users/user/handstracking-master/img/background.png')
